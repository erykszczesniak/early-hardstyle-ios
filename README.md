...
Design tokens, screen maps and the motion language live in [`the design spec`](the design spec): minimalist **black / white / electric blue**, with 3D used as depth and motion — never as gimmick, and always degrading gracefully under Reduce Motion.
