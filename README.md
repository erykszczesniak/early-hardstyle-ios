...
**Status:** 🚧 in active development — see the [feature roadmap](#). This README is expanded in the final documentation PR.
...
├── the project brief                 engineering operating manual
└── the design spec                 UI/UX single source of truth
```
...
Minimalist, modern: **black / white / electric blue**, with 3D used as depth and motion — never as gimmick. The full design system, tokens, screen maps and motion language live in [`the design spec`](the design spec).
